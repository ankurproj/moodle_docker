...
$string['checkstatus'] = 'Check Application Status';
$string['email'] = 'Email';
...
$string['schemedetails'] = 'Enrolled schemes (courses)';
...
$string['schemenotice'] = 'Below are the courses the user is enrolled in.';
